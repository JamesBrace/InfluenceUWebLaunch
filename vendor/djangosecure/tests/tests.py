...
class SecurityMiddlewareTest(TestCase):
    @property
    def middleware(self):
        from vendor.djangosecure.middleware import SecurityMiddleware
...
class FrameDenyExemptTest(TestCase):
    def test_adds_exempt_attr(self):
        ...
        """
        from vendor.djangosecure.decorators import frame_deny_exempt
...
class RunChecksTest(TestCase):
    @property
    def func(self):
        from vendor.djangosecure import run_checks
        return run_checks
...
class CheckSessionCookieSecureTest(TestCase):
    @property
    def func(self):
        from vendor.djangosecure.check.sessions import check_session_cookie_secure
...
class CheckSessionCookieHttpOnlyTest(TestCase):
    @property
    def func(self):
        from vendor.djangosecure.check.sessions import check_session_cookie_httponly
...
class CheckCSRFMiddlewareTest(TestCase):
    @property
    def func(self):
        from vendor.djangosecure import check_csrf_middleware
...
class CheckSecurityMiddlewareTest(TestCase):
    @property
    def func(self):
        from vendor.djangosecure import check_security_middleware
...
class CheckStrictTransportSecurityTest(TestCase):
    @property
    def func(self):
        from vendor.djangosecure import check_sts
        return check_sts
...
class CheckStrictTransportSecuritySubdomainsTest(TestCase):
    @property
    def func(self):
        from vendor.djangosecure import check_sts_include_subdomains
...
class CheckFrameDenyTest(TestCase):
    @property
    def func(self):
        from vendor.djangosecure import check_frame_deny
...
class CheckContentTypeNosniffTest(TestCase):
    @property
    def func(self):
        from vendor.djangosecure import check_content_type_nosniff
...
class CheckXssFilterTest(TestCase):
    @property
    def func(self):
        from vendor.djangosecure import check_xss_filter
...
class CheckSSLRedirectTest(TestCase):
    @property
    def func(self):
        from vendor.djangosecure import check_ssl_redirect
...
class CheckSecretKeyTest(TestCase):
    @property
    def func(self):
        from vendor.djangosecure import check_secret_key
...
class ConfTest(TestCase):
    def test_no_fallback(self):
        ...
        """
        from vendor.djangosecure import conf
